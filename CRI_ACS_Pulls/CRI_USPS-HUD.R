...
HUD2019 <- full_join(full_join(full_join(HUD2019q1, HUD2019q2), HUD2019q3), HUD2019q4)

#group dataframe by matching geoid and then calculate mean of all columns with matching geoid
HUD2019.s <- HUD2019 %>%
  group_by(geoid) %>%
...
#export to .csv
export(HUD2019.i, "PASTE EXPORT FILE LOCATION HERE")
