...
# OWEN I'm unsure about ocb/rcb and ocbp/rcbp being included in the index but the eigenvalue plot earlier in the PCA shows them in pretty disparate areas, your input would be appreciated.
