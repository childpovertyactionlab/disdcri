...
summary(hel.pca) # proportion of variance reveals which PC are the most valued.
fviz_eig(hel.pca) # scree plot  depicting what % of variance is explained by each principal component.
fviz_pca_var(hel.pca, # plots all variables against first & second dimension to visualize contribution of each variable to PCA.
